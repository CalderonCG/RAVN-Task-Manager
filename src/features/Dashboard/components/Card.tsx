...
function Card({ task, variant = "card" }: TaskCardProps) {
  ...
  // List
  return (
    <div className="w-220 lg:w-full h-14 items-center font-normal text-font bg-background-secondary border-1 border-background-modal grid grid-cols-20 py-0.5">
